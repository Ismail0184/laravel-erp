...
Route::get('/', [HomeController::class,'index']);
    ...
    Route::get('/accounts/voucher/journal/status/{voucher_no}', [JournalVoucherController::class,'status'])->name('acc.voucher.journal.status');
    ...
    Route::get('/accounts/voucher/journal/voucher/edit/{voucher_no}', function (Request $request){ session(['journal_no'=>request('voucher_no')]);
    ...
    Route::get('/accounts/voucher/contra/status/{voucher_no}', [ContraVoucherController::class,'status'])->name('acc.voucher.contra.status');
    ...
    Route::get('/accounts/voucher/contra/delete_attachment_while_edit/{id}', [ContraVoucherController::class,'deleteAttachmentContraVoucher'])->name('acc.voucher.contra.deleteAttachmentContraVoucher');
