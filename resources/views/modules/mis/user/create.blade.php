                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" readonly @if(request('id')>0) value="{{$employee->code}}" @endif class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" readonly @if(request('id')>0) value="{{$employee->full_name}}" @endif class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="email" readonly @if(request('id')>0) value="{{$employee->jobInfoTable->corporate_email}}" @endif class="form-control">
                        </div>
                    </div>
