    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$title}} <a href="{{route('hrm.setup.eduExamtitle.create')}}" class="btn btn-success" style="margin-left: 72.3%"><i class="mdi mdi-plus mr-1"></i> Add New</a></h4>
