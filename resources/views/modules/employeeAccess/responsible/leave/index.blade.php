...
@section('title')
    @php($title = 'Responsible for Leave Applications') {{$title}}
@endsection
                            ...
                            @foreach($leaveApplications as $leaveApplication)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle">
                                        <a href="{{route('ea.responsibleFor.leave.show',['id' => $leaveApplication->id])}}" title="show" class="btn btn-primary btn-sm">
