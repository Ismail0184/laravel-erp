...
@section('title')
    @php($title = 'Responsible for Early Leave Applications') {{$title}}
@endsection
                            ...
                            @foreach($earlyLeaveApplications as $earlyLeaveApplication)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle">
                                        <a href="{{route('ea.responsibleFor.earlyLeave.show',['id' => $earlyLeaveApplication->id])}}" title="show" class="btn btn-primary btn-sm">
