...
@section('body')
                                    ...
                                    @if($leaveApplication->status=='PENDING')
                                        <div class="col-md-6 text-left">
                                            <form action="{{route('ea.recommendation.leave.recommend', ['id'=>$leaveApplication->id])}}" method="post">
                                                ...
                                                <input type="hidden" name="remarks_while_recommended" id="remarks_while_recommended">

                                                <button type="submit" class="btn btn-success mt-4 pr-4 pl-4 text-white" onclick="return window.confirm('Confirm?');">Recommend & Forward <i class="fa fa-arrow-alt-circle-right"></i></button>
                                            </form>
                                            <form action="{{route('ea.recommendation.leave.reject', ['id'=>$leaveApplication->id])}}" method="post">
                                                @csrf
                                                <input type="hidden" name="remarks_while_recommended" id="remarks_while_recommended_reject">
    ...
    <script>
        function updateInput2() {
            ...
            document.getElementById('remarks_while_recommended').value = input1Value;
            document.getElementById('remarks_while_recommended_reject').value = input1Value;
        }
    </script>
@endsection
