            ...
            <div class="card-body">
                ...
                <form style="font-size: 11px" method="POST" action="@if(Session::get('payment_no')>0) {{route('acc.voucher.payment.mupdate', ['voucher_no'=>$masterData->voucher_no])}} @else {{route('acc.voucher.payment.initiate')}} @endif">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="text" readonly name="voucher_no" @if(Session::get('payment_no')>0) value="{{Session::get('payment_no')}}" @else value="{{$journalVoucher}}" @endif class="form-control" required />
                        </div>
