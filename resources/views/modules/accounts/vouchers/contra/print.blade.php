...
<head>
    <meta charset="utf-8" />
    <title>Contra Voucher # {{request('voucher_no')}}</title>
...
<div class="invoice-box">
    <table style="font-size: 11px">
        ...
        <tr>
            <td colspan="5">
                <h3 style="text-align: center; font-size: 25px; margin-top: -60px;">CONTRA VOUCHER</h3>
            </td>
        </tr>
        ...
        @foreach($contras as $contra)
            <tr class="item">
                ...
                <td style="text-align: left; vertical-align: middle">{{$contra->ledgerforvoucher->ledger_name}}</td>
                <td style="text-align: left; vertical-align: middle">{{$contra->narration}}</td>
