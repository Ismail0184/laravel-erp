...
<head>
    <meta charset="utf-8" />
    <title>Cheque Payment Voucher # {{request('voucher_no')}}</title>
...
<div class="invoice-box">
    <table style="font-size: 11px">
        ...
        <tr>
            <td colspan="5">
                <h3 style="text-align: center; font-size: 25px; margin-top: -60px;">Cheque PAYMENT VOUCHER</h3>
            </td>
        </tr>
        ...
        @foreach($cpayments as $cpayment)
            <tr class="item">
                ...
                <td style="text-align: left; vertical-align: middle">{{$cpayment->ledgerforvoucher->ledger_name}}</td>
                <td style="text-align: left; vertical-align: middle">{{$cpayment->narration}}</td>
