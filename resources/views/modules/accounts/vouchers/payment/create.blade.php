    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form style="font-size: 11px" method="POST" action="@if(Session::get('payment_no')>0) {{route('acc.voucher.receipt.mupdate', ['voucher_no'=>$masterData->voucher_no])}} @else {{route('acc.voucher.receipt.initiate')}} @endif">
                    @csrf
                    ...
                    <div class="form-group row mb-2">
                        <label for="horizontal-firstname-input" class="col-sm-1 col-form-label">Payment No <span class="required text-danger">*</span></label>
                        <div class="col-sm-3">
