...
<head>
    <meta charset="utf-8" />
    <title>Payment Voucher # {{request('voucher_no')}}</title>
...
<div class="invoice-box">
    <table style="font-size: 11px">
        ...
        <tr>
            <td colspan="5">
                <h3 style="text-align: center; font-size: 25px; margin-top: -60px;">PAYMENT VOUCHER</h3>
            </td>
        </tr>
        ...
        @foreach($payments as $payment)
            <tr class="item">
                ...
                <td style="text-align: left; vertical-align: middle">{{$payment->ledgerforvoucher->ledger_name}}</td>
                <td style="text-align: left; vertical-align: middle">{{$payment->narration}}</td>
            ...
            @php($dr_total = $dr_total +$payment->dr_amt )
