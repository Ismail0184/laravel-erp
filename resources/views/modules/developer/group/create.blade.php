    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="@if(request('id')>0) {{route('dev.group.update', ['id'=>$group->id])}} @else {{route('dev.group.store')}} @endif">
                    @csrf
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="group_id" @if(request('id')>0) value="{{$group->name}}" @endif class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="group_name" @if(request('id')>0) value="{{$group->group_name}}" @endif class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="address" @if(request('id')>0) value="{{$group->address}}" @endif class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="website" @if(request('id')>0) value="{{$group->website}}" @endif class="form-control" required>
                        </div>
                    </div>
                    @if(request('id')>0)
